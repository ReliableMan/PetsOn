...
export default function Post() {
  return (
    ...
    <div className='container-post'>
      <Link className='post1' to="/post1">Название статьи</Link>
      <Link className='post2' to="/post2">Название статьи</Link>
      <Link className='post3' to="/post3">Название статьи</Link>
    </div>
